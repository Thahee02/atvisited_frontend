                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li><Link to="/featured" className="hover:text-emerald-400 transition-colors">Featured</Link></li>
                            <li><Link to="/nearby" className="hover:text-emerald-400 transition-colors">Nearby Places</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li className="flex items-center gap-3"><Mail size={16} className="text-emerald-500" /> hello@atvisited.com</li>
                            <li className="flex items-center gap-3"><Phone size={16} className="text-emerald-500" /> +94 76 123 4567</li>
                            <li className="flex items-center gap-3"><Globe size={16} className="text-emerald-500" /> global.atvisited.com</li>
                        </ul>
                    </div>
                </div>
